#Parameter Optimisation - 1,652 seconds / 27 minute completion 
import numpy as np
import pandas as pd
import math
import pandas as pd
...
STRATEGY_PARAMS = dict(period = 20, devfactor= 2.0)
...
toolbox.register("mutate", tools.mutUniformInt, low=[30,2], up=[120,3], indpb=0.2)
# selection strategy
...
toolbox.register("attr_period", random.randint, 30, 120)
toolbox.register("attr_devfactor", random.randint, 2, 3)
toolbox.register(
    "individual",
    tools.initCycle,
    creator.Individual,
